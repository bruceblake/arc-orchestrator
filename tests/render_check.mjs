...
const mod = new Function(externals + "\n" + js + "\nreturn {renderHealth, card, renderTasks, renderDag, renderFeed, taskDag, friendly, esc, renderProjects, projectMatches, visibleProjects, loadHash, pollProjects, pollTopos, openDetail, closeDetail, renderSlots, renderGithub, setGH: v => { GH = v; }};");
const api = mod();
