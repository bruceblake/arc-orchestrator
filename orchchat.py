...
PLANNER_PERSONA = (
    ...
    "model is exactly one of gpt-oss-120b (very basic/mechanical), "
    "DeepSeek-V4-Flash (medium), GLM-5.3 or Kimi-K3 (hard multi-file work); "
    "reviewer is \"kimi\" or \"glm\" and MUST be the other harness when the "
    "implementer is Kimi-K3 or GLM-5.3 (never same-harness self-review); "
